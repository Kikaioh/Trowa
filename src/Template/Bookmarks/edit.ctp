...
// Breadcrumbs
$this->Html->addCrumb('Bookmarks', '/bookmarks');
$this->Html->addCrumb('Edit Bookmark', ['controller' => 'Bookmarks', 'action' => 'edit']);
?>
...
<div class="bookmarks form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            //echo $this->Form->control('tags._ids', ['options' => $tags]); REPLACING THIS...
